#
# OMNeT++/OMNEST Makefile for datacenter_simulation
#
...
TARGET = datacenter_simulation$(EXE_SUFFIX)
...
INCLUDE_PATH = -I$(QUEUEINGLIB_PROJ) -I. -Isimulations -Isrc
...
OBJS = $O/src/MsgAllocator.o $O/src/BetterRouter.o
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f datacenter_simulation datacenter_simulation.exe libdatacenter_simulation.so libdatacenter_simulation.a libdatacenter_simulation.dll libdatacenter_simulation.dylib
	$(Q)-rm -f ./*_m.cc ./*_m.h
